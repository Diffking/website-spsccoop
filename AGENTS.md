...
ถ้าโดนแบนจริง: เว็บของบริษัทโฮสต์เอง (`hostinglotus.net`) ก็จะเข้าไม่ได้จากเครื่องเราด้วย
แก้โดยแจ้งบริษัทให้ปลดไอพีออกจาก deny list (CSF/Imunify360) หรือรีสตาร์ตเราเตอร์เอาไอพีใหม่
(ปลอดภัยกับ `cloudflared` เพราะเป็นการเชื่อมต่อขาออก ต่อกลับเองเมื่อเน็ตมา)
