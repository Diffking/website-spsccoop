...
export const breakingNews = [
  "ปรับหลักเกณฑ์การสงเคราะห์สมาชิกผู้เสียชีวิต",
  "ประกาศที่ 18/2569 อัตราดอกเบี้ยเงินฝากออมทรัพย์พิเศษฉบับใหม่",
  "ประกาศที่ 17/2569 กำหนดการประชุมใหญ่สามัญประจำปี 2569",
];

export type NewsItem = { no: string; title: string; date: string; href: string };

export const announcements: NewsItem[] = [
  { no: "19/2569", title: "จ่ายเงินสวัสดิการสงเคราะห์สมาชิกผู้เสียชีวิต", date: "30 มิ.ย. 2569", href: "#" },
  { no: "18/2569", title: "อัตราดอกเบี้ยเงินฝากออมทรัพย์พิเศษฉบับใหม่", date: "25 มิ.ย. 2569", href: "#" },
  { no: "17/2569", title: "กำหนดการประชุมใหญ่สามัญประจำปี 2569", date: "22 มิ.ย. 2569", href: "#" },
  { no: "16/2569", title: "หลักเกณฑ์การให้เงินกู้สามัญเพื่อการศึกษาบุตร", date: "19 มิ.ย. 2569", href: "#" },
  { no: "15/2569", title: "วันหยุดทำการของสหกรณ์ประจำเดือนกรกฎาคม", date: "15 มิ.ย. 2569", href: "#" },
];

export const committees = [
  { name: "— ชื่อ-สกุล —", role: "ประธานกรรมการ" },
  { name: "— ชื่อ-สกุล —", role: "รองประธานกรรมการ" },
  { name: "— ชื่อ-สกุล —", role: "เลขานุการ" },
];
