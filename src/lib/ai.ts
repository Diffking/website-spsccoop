...
const SLIDE_SCHEMA = {
  ...
  properties: {
    title: {
      type: "string",
      description:
        "เรื่องอะไร — ขึ้นต้นด้วยชนิดของเรื่องตามที่ภาพบอก (โครงการ / อบรม / สัมมนา / " +
        "ประชุมใหญ่ / รับสมัคร / ขอเชิญ / ประกาศ / แจ้ง) แล้วตามด้วยเรื่องที่ทำ " +
        "เช่น “อบรมอาชีพเสริม ครั้งที่ 2/2569” · **ไม่เกิน 60 ตัวอักษร** " +
        "ตัดชื่อสหกรณ์ ชื่อหัวข้อย่อย และข้อความในเครื่องหมายคำพูดออกได้ถ้ายาวเกิน",
    },
    caption: {
      type: "string",
      description:
        "เงื่อนไขและวิธีเข้าร่วม เขียนให้จบใน 2 ประโยค ยาวรวมไม่เกิน 200 ตัวอักษร " +
        "เลือกเฉพาะข้อที่สมาชิกใช้ตัดสินใจว่าจะเข้าร่วมไหม (ใครมีสิทธิ์ · รับกี่คน · " +
        "ปิดรับเมื่อไร · สมัครทางไหน) ที่เหลืออยู่ในภาพให้เขาอ่านเองอยู่แล้ว " +
        "ห้ามลอกทั้งใบ ห้ามไล่เป็นข้อ ๆ ห้ามซ้ำหัวข้อ",
    },
    eventDate: {
      type: "string",
      description:
...
export function readSlideFromImage(base64: string, mediaType: MediaType) {
  return readImage<SlideDraft>(
    ...
    "นี่คือภาพประกาศของสหกรณ์ออมทรัพย์ อ่านข้อความในภาพให้ครบทุกบรรทัดก่อนตอบ " +
      ...
      "(3) เงื่อนไขเป็นอย่างไร — ใครมีสิทธิ์ รับจำนวนเท่าไร สมัครหรือติดต่อทางไหน " +
      "ต้องเตรียมอะไร จัดที่ไหน มีค่าใช้จ่ายหรือไม่ " +
      "ข้อความที่ตอบกลับจะไปวางเป็นแบนเนอร์ข้างรูปบนหน้าเว็บ ซึ่งมีที่ให้แค่ไม่กี่บรรทัด " +
      "**ต้องสั้นและจบประโยค** สมาชิกที่อยากรู้ละเอียดกดดูรูปเต็มได้อยู่แล้ว — " +
      "หัวข้อไม่เกิน 60 ตัวอักษร คำอธิบายไม่เกิน 200 ตัวอักษร ห้ามลอกข้อความทั้งใบมาใส่ " +
