...
export default async function AdminFooterPage() {
  ...
  const [siteInfo, links] = await Promise.all([getSiteInfo(), getItemsForAdmin("footerLinks")]);

  return (
    <main className="mx-auto max-w-4xl px-4 py-6">
      <h1 className="mb-1 text-xl font-bold text-gray-800">ส่วนท้ายเว็บ</h1>
      <p className="mb-5 text-sm text-gray-500">ข้อมูลติดต่อและลิงก์หน่วยงานที่ขึ้นท้ายทุกหน้า</p>
