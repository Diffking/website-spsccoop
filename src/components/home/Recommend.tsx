...
import { recommends, memberFeatures } from "@/data/home";
        ...
        <div className="grid gap-5 md:grid-cols-3">
          {recommends.map((r, i) => (
            <Reveal key={r.title} delay={i * 0.08}>
              <Link
                href={r.href}
                className={`group relative flex h-40 flex-col justify-between overflow-hidden rounded-2xl bg-gradient-to-br ${THEME[r.theme]} p-6 text-white shadow-md transition hover:shadow-xl`}
              >
