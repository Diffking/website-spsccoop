...
export default function Hero({
  ...
  return (
    /*
      ...
      py-[200px] = แถบพื้นสีฟ้าเหนือและใต้การ์ด เจ้าของเว็บกำหนดเองว่าเอาราว 200px
      เท่ากันบนล่าง (24 ส.ค. 2026) · ทำงานร่วมกับ min-h ข้างบน: จอสูงมากได้ระยะ
      มากกว่า 200 เพราะจัดกึ่งกลางเต็มจอ · จอปกติได้ 200 พอดีตามที่สั่ง
      มือถือใช้ py-10 เพราะ 200px บนจอเล็กคือพื้นที่ว่างเกือบครึ่งจอ
    */
    <section className="flex min-h-[calc(100dvh-9rem)] items-center bg-gradient-to-b from-brand-500 to-brand-300 py-10 md:py-[200px]">
      {/*
