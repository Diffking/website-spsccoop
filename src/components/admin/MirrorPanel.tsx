 ...
 * ปกติสำเนาอัปเดตเองอยู่แล้ว (ของที่แก้ขึ้นเองภายใน 2 นาที + มีตัวอุ่นวันละ 2 ครั้ง) แต่เจ้าหน้าที่
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="mt-0.5 text-xs leading-relaxed text-gray-500">
              ...
              วันละ 2 ครั้ง (09:30 และ 15:30 น.) · ของที่แก้ขึ้นเองภายใน 2 นาที · สถานะตรงนี้ถามโฮสต์ทุก 6 ชม. (กันไอพีสำนักงานโดนแบน)
            </p>
          </div>
        </div>
